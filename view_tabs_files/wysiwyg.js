...
//	"maximize": 	  ['Maximize', 			   'Maximize the editor',   'maximize.gif', 		  'maximize_on.gif']
	...
	/**
	 * Generate WYSIWYG editor for a given textarea element
	 *
	 * @param {String} id Textarea identifier
...
var WYSIWYG_Core = {
	...
	/**
     * Holds true if browser is Chrome, otherwise false
	 */
	 ...
	 */
	isFF: (!document.all && document.getElementById && (navigator.appName != "Opera") && (navigator.userAgent.indexOf('Chrome') == -1) && (navigator.userAgent.indexOf('Safari') == -1)),

	/**
	 * Holds true if browser is Safari, otherwise false
	 */
	...
	isBrowserCompatible: function() {
		...
		if(WYSIWYG_Core.isSafari || !document.getElementById || !document.designMode){
